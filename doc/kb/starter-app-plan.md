# Tilr — Starter App Plan

A foundation-only Swift app that proves out the primitives we'll need for a
full native port of the existing Hammerspoon Tilr (lives at
`~/Code/github/jimbarritt/dotfiles/home/hammerspoon/init.lua`). No window
...
For broader product/engineering context, see `specifications.md` in this
directory.
